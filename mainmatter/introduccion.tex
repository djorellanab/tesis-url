...
Por otro lado el estudio, RGB-D mapping: Using Kinect-style depth cameras for dense 3D modeling of indoor environments   \cite{henry2012rgb}, indica que las cámaras con sensor de profundidad capturan píxeles de información de imágenes (RGB) y de profundidad, tal como se muestra en la siguiente figura:
\begin{figure}[h]
...
\end{itemize}
Tal como se observa en el listado, todas las cámaras RGB-D permite detectar características del ambiente, por lo cual a la hora de escoger una cámara RGB-D se debe tomar las siguientes especificaciones:
\begin{itemize}
	\item \textbf{Alcance del sensor 3D:}
	\item \textbf{3D Resolución:}
	\item \textbf{RGB Resolución:}
	\item \textbf{\acrfull{FOV}:}
	\item \textbf{\acrfull{Conexión}:}
\end{itemize}

\begin{table}[H]
\begin{center}
\caption{Comparación de especificaciones entre RGB-D cameras}
\label{tab:RGBD}
