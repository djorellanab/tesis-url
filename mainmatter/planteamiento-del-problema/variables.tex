...
\begin{enumerate}
	\item[A.] \textbf{Desplazamiento de la articulaci\'on}: Valor decimal positivo -i.e. Medida en metros- que determina la distancia de una articulaci\'on y un punto de origen -i.e. Kinect-:
\end{enumerate}
\medbreak
\begin{figure}[H]
