...
El médico, \citeA{hoppenfeld1979exploracion}, realizó un manual clínico que enseña los conocimientos básicos de la exploración física de la columna vertebral y sus extremidades, así mismo muestra la estructura del cuerpo con sus respectivos arcos de movilidad (i.e. Pruebas de movimientos):
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[1.]
    	\item Flexión: Movimiento que consta en tocar el pecho (i.e. Tórax) con la barbilla.
    	\item Extensión: Movimiento la cual el paciente debe ver directamente hacia el techo. 
    	\item Rotación: Movimiento la cual el paciente debe ver lo que tiene a su derecha e izquierda.
    	\item Inclinación: Movimiento la cual el paciente debe inclinar la cabeza a 45°.
    \end{enumerate}
\end{enumerate}