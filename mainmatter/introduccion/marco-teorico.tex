...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=400px,height=210px]{graphics/interacionKinect.png} \\
...
\begin{itemize}
	\item \textbf{Update Configuration Definitions:} Verifica que tenga la última versión del SDK (e.g. V.2.0.1410.19000).
