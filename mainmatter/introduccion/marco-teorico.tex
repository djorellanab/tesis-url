...
Según el libro, Kinect for Windows SDK Programming Guide \cite{jana2012kinect}, menciona que el dispositivo Kinect se desarrolló para la consola de videojuegos, Xbox 360, además proporciona una \acrfull{NUI}, que permite interactuar con el dispositivo, a partir de movimientos, gestos y sonidos, esto permitió crear la idea de tecnologías con control de manos libres.
\medbreak
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=500px,height=200px]{graphics/kinect-parts.PNG} \\
	\textbf{Fuente:} Tomado por el autor de tesis
\end{figure}